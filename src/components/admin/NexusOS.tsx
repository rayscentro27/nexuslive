...
import { NexusProofSummary } from '../nexus-os/NexusProofSummary';
...
const NAV: NavItem[] = [
  ...
  { id: 'showroom', label: 'Showroom', icon: Store, description: 'Review approval assets' },
  { id: 'proof', label: 'Proof', icon: FileCheck2, description: 'Communication, money & automation evidence' },
...
export function NexusOS() {
  ...
  function renderSection() {
    switch (activeSection) {
      ...
      case 'proof':          return <NexusProofSummary onNavigate={setActiveSection} />;
